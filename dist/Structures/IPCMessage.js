...
var IPCMessage = (function (_super) {
    ...
    function IPCMessage(instance, message, res) {
    ...
    IPCMessage.prototype.send = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                baseMessage = new BaseMessage(__assign(__assign({}, message), { _type: discord_hybrid_sharding_1.messageType.CUSTOM_MESSAGE }));
    ...
    IPCMessage.prototype.request = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (typeof message !== 'object')
                    throw new TypeError('The Message has to be a object');
                baseMessage = new BaseMessage(__assign(__assign({}, message), { _type: discord_hybrid_sharding_1.messageType.CUSTOM_REQUEST, nonce: this.nonce }));
    ...
    IPCMessage.prototype.reply = function (message) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                if (typeof message !== 'object')
                    throw new TypeError('The Message has to be a object');
                baseMessage = new BaseMessage(__assign(__assign({}, message), { _type: discord_hybrid_sharding_1.messageType.CUSTOM_REPLY, nonce: this.nonce, _result: message }));
                return [2, (_a = this.res) === null || _a === void 0 ? void 0 : _a.call(this, baseMessage.toJSON())];
            });
        });
    };
    return IPCMessage;
